...
import "./yookassa_construct_form.css";
...
const config = {
    ...
    redirectSucceeded: "http://localhost:3000/succeeded",
    redirectError: "http://localhost:3000/error",
    paymentDescriptio: "Заказ №100000",
    shopId: "964688",
    inputPrice() {
        const price = String(this.price);
        const modPrice = price.split(/(?=(?:...)*$)/).join(" ");
        return <span>{modPrice},00 ₽</span>;
    },
};

const FormYookassa = () => {
    console.log(config.inputPrice());
    return (
        <>
            <br />
            <form
            ...
            >
                <div className="ym-products">
                    <div className="ym-block-title ym-products-title">
                        Товары
                    </div>
                    ...
                    <div className="ym-product">
                        <div className="ym-product-line">
                            <span className="ym-product-description">
                                <span className="ym-product-count">
                                    {config.quantity}×
                                </span>
                                {config.product}
                            </span>
                ...
                <div className="ym-hidden-inputs">
                    <input
                        name="shopSuccessURL"
                        type="hidden"
                        value={config.redirectSucceeded}
                    />
                    <input
                        name="shopFailURL"
                        type="hidden"
                        value={config.redirectError}
                    />
                </div>
                ...
                <input
                    name="customerNumber"
                    type="hidden"
                    value={config.paymentDescriptio}
                />
                ...
                <input name="shopId" type="hidden" value={config.shopId} />
            </form>
